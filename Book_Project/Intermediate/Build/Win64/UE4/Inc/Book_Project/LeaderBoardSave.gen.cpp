...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_completedTutorial_MetaData[];
#endif
		static void NewProp_completedTutorial_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_completedTutorial;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial_MetaData[] = {
		{ "Category", "LeaderBoardSave" },
		{ "ModuleRelativePath", "LeaderBoardSave.h" },
	};
#endif
	void Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial_SetBit(void* Obj)
	{
		((ULeaderBoardSave*)Obj)->completedTutorial = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial = { "completedTutorial", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULeaderBoardSave), &Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULeaderBoardSave_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULeaderBoardSave_Statics::NewProp_completedTutorial,
	...
	IMPLEMENT_CLASS(ULeaderBoardSave, 587998796);
