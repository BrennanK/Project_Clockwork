...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_launchZ_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_launchZ;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_launchXY_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_launchXY;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchZ_MetaData[] = {
		{ "Category", "Rail Variables" },
		{ "ModuleRelativePath", "Grindable_Rail.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchZ = { "launchZ", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGrindable_Rail, launchZ), METADATA_PARAMS(Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchZ_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchZ_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchXY_MetaData[] = {
		{ "Category", "Rail Variables" },
		{ "ModuleRelativePath", "Grindable_Rail.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchXY = { "launchXY", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGrindable_Rail, launchXY), METADATA_PARAMS(Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchXY_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchXY_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGrindable_Rail_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchZ,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGrindable_Rail_Statics::NewProp_launchXY,
	...
	IMPLEMENT_CLASS(AGrindable_Rail, 1964127819);
