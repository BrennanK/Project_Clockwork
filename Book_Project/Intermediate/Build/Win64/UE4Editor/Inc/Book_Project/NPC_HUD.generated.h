...
#ifdef BOOK_PROJECT_NPC_HUD_generated_h
#error "NPC_HUD.generated.h already included, missing '#pragma once' in NPC_HUD.h"
#endif
...
public: \
	DECLARE_CLASS(ANPC_HUD, AHUD, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/Book_Project"), NO_API) \
...
#define Book_Project_4_23_Source_Book_Project_NPC_HUD_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ANPC_HUD); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ANPC_HUD); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ANPC_HUD(ANPC_HUD&&); \
	NO_API ANPC_HUD(const ANPC_HUD&); \
public:
